...
import (
	...
	webhookpdaiv1alpha1 "github.com/pd-ai/pd-manager/internal/webhook/v1alpha1"
...
func init() {
	...
	utilruntime.Must(pdaiv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "27281c4e.pdai.io",
	...
	if err = (&controller.PDInferenceServiceReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "PDInferenceService")
		os.Exit(1)
	}
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = webhookpdaiv1alpha1.SetupPDInferenceServiceWebhookWithManager(mgr); err != nil {
			setupLog.Error(err, "unable to create webhook", "webhook", "PDInferenceService")
			os.Exit(1)
		}
	}
